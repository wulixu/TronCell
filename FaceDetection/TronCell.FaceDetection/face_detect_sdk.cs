...
namespace TronCell.FaceDetection
{
    static class face_detect_sdk
    {
        ...
        [DllImport("EVAL_x86_Accuracy.dll")]
        unsafe public static extern int PFD_Init(int maxFaceNum,int imgSize);
        [DllImport("EVAL_x86_Accuracy.dll")]
        ...
        [DllImport("EVAL_x86_Accuracy.dll")]
        public static extern int PFD_GetFeature([MarshalAs(UnmanagedType.LPArray)] byte[] mem, ref PFD_FACE_DETECT faceInfo, [MarshalAs(UnmanagedType.LPArray)] IntPtr[] feature, short faceRote);
        [DllImport("EVAL_x86_Accuracy.dll")]
        ...
        [DllImport("EVAL_x86_Accuracy.dll")]
        public static extern int PDB_StoreFeature(short fsize,[MarshalAs(UnmanagedType.LPArray)] byte[] feature);
        [DllImport("EVAL_x86_Accuracy.dll")]
        public static extern int PDB_DeleteFeature(int usid);
        [DllImport("EVAL_x86_Accuracy.dll")]
        public static extern int PDB_MatchFeature(uint threshold, short fsize, [MarshalAs(UnmanagedType.LPArray)] byte[] feature, ushort num, [MarshalAs(UnmanagedType.LPArray)] int[] candidate, [MarshalAs(UnmanagedType.LPArray)] short[] score);
    }
}
